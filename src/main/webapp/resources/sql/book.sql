CREATE DATABASE SPRINGMVCDB DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ; -- 윈도우 명령 프롬프트의 기본 문자셋이 euckr 이면 utf8 로 문자셋 변경할 것
...
DELETE FROM book; -- book 테이블이 있다면 삭제
